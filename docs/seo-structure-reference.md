...
- **Dubrovnik to Šibenik — €500**: `taxi-dubrovnik-sibenik` / `taxi-dubrovnik-do-sibenika` / `taxi-dubrovnik-nach-sibenik` / `taksowka-dubrownik-sibenik`. EN: `Taxi Dubrovnik to Šibenik | Private Transfer €500`. HR: `Taxi Dubrovnik do Šibenika | Privatni transfer 500 € | TAXI Antonio`. DE: `Taxi Dubrovnik nach Šibenik | Privater Transfer 500 € | TAXI Antonio`. PL: `Taksówka Dubrownik do Šibenika | Prywatny transfer 500 € | TAXI Antonio`. EN meta: Private taxi from Dubrovnik (or airport) to Šibenik. Fixed €500 per car, English-speaking driver, door-to-door. HR meta: Privatni taxi iz Dubrovnika (ili aerodroma) do Šibenika. Fiksna cijena 500 € po vozilu, engleski govorni vozač, od vrata do vrata. DE meta: Privates Taxi von Dubrovnik (oder Flughafen) nach Šibenik. Festpreis 500 € pro Auto, englischsprachiger Fahrer, Tür-zu-Tür. PL meta: Prywatna taksówka z Dubrownika (lub lotniska) do Šibenika. Stała cena 500 € za samochód, kierowca mówiący po angielsku, door-to-door.
...
- **Šibenik to Dubrovnik — €500**: `taxi-sibenik-dubrovnik` / `taxi-sibenik-do-dubrovnika` / `taxi-sibenik-nach-dubrovnik` / `taksowka-sibenik-dubrownik`. EN: `Taxi Šibenik to Dubrovnik | Private Transfer €500`. HR: `Taxi Šibenik do Dubrovnika | Privatni transfer 500 € | TAXI Antonio`. DE: `Taxi Šibenik nach Dubrovnik | Privater Transfer 500 € | TAXI Antonio`. PL: `Taksówka Šibenik do Dubrownika | Prywatny transfer 500 € | TAXI Antonio`.
...
- **Šibenik to Zagreb — €500**: `taxi-sibenik-zagreb` / `taxi-sibenik-do-zagreba` / `taxi-sibenik-nach-zagreb` / `taksowka-sibenik-zagrzeb`. EN: `Taxi Šibenik to Zagreb | Fixed Transfer Price €500`. HR: `Taxi Šibenik do Zagreba | Fiksna cijena 500 € | TAXI Antonio`. DE: `Taxi Šibenik nach Zagreb | Festpreis 500 € | TAXI Antonio`. PL: `Taksówka Šibenik do Zagrzebia | Stała cena 500 € | TAXI Antonio`. EN meta: Private taxi Šibenik to Zagreb. Drop off in center or airport. Takes about 3.5 to 4 hours. Fixed €500 per car, English-speaking driver, door-to-door.
...
- **Zagreb to Šibenik — €500**: `taxi-zagreb-sibenik` / `taxi-zagreb-do-sibenika` / `taxi-zagreb-nach-sibenik` / `taksowka-zagrzeb-sibenik`. EN: `Taxi Zagreb to Šibenik | Fixed Transfer Price €500`. HR: `Taxi Zagreb do Šibenika | Fiksna cijena 500 € | TAXI Antonio`. DE: `Taxi Zagreb nach Šibenik | Festpreis 500 € | TAXI Antonio`. PL: `Taksówka Zagrzeb do Šibenika | Stała cena 500 € | TAXI Antonio`.
